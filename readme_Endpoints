...
With these updated endpoints, you can integrate Firebase Cloud Messaging to send push notifications to the recipient user when a new message is received. Upon receiving the notification, the user can access the unread messages by retrieving them using the "Get Unread Challenge Messages" endpoint. Once the user has read a message, you can use the "Mark Message as Read" endpoint to update the message status and avoid duplicate notifications.
